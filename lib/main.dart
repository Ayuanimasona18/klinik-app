...
void main() => runApp(
    MyApp()); //Fungsi main() merupakan titik masuk (entry point) dari aplikasi Flutter. Di sini, kita membuat instance dari kelas MyApp dan menjalankannya dengan runApp().
